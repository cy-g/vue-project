<template>
  <div class="shop-header">
    <nav class="shop-nav">
      <a href="javascript:void(0)" class="back" @click="backed">
        <i class="iconfont icon-arrow_left"></i>
      </a>
    </nav>
    <div class="shop-content">
      <img class="content-image" :src="`https://cyfirst.oss-cn-beijing.aliyuncs.com/${shopone.logo}`">
      <div class="header-content">
        <h2 class="content-title">
          <span class="content-tag">
            <span class="mini-tag">品牌</span>
          </span>
          <span class="content-name">{{shopone.shopname}}</span>
